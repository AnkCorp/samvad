...
The goal of this project is simple, create an open source toolkit that will help to train a model to convert American Sign Language (or any other sign language) into English.
